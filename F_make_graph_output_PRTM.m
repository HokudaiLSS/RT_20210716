function  F_make_graph_output_PRTM(filename, outputs_PRTM,OF_lim)
dir=('graph');
mkdir(dir);
...
% Top plot
ax1 = nexttile;
plot(ax1, outputs_PRTM.time, outputs_PRTM.efficiency_combustion,'k');
yline(outputs_PRTM.efficiency_combustion,'k')
h_axes = gca;
...
% Middle plot
ax2 = nexttile;
plot(ax2,outputs_PRTM.time, outputs_PRTM.mass_fuelconsumption,'k')
yline(outputs_PRTM.mass_fuelconsumption,'--k')
hold on
%time=1:1:7;
% Mass_Fuel = cumtrapz(outputs_PRTM.massflowrate_fuel);

plot(ax2,outputs_PRTM.time, outputs_PRTM.mass_fuelconsumption_history,'k')
hold off
h_axes = gca;
h_axes.YAxis.FontSize = 8;
h_axes.YAxis.FontName = 'Times';
...
% Bottom plot
ax3 = nexttile;
plot(ax3,outputs_PRTM.time, outputs_PRTM.ratio_oxidizertofuelmass,'k')
h_axes = gca;
h_axes.YAxis.FontSize = 8;
h_axes.YAxis.FontName = 'Times';
